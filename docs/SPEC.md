...
- **ASN-015**: `add` MUST require `assignment_id`, `responsibility_key`, and `instructions_sha256`; it MAY accept `separation`, `wait`, and the `emergency` claim of BUD-016.
